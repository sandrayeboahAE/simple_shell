...
/**
 * write_history - function to create a file, or appends to an existing file
 * @info: parameter struct
 ...
 * @info: Structure containing potential arguments which is used to
 ...
 * after changes
 * @info: tructure containing potential arguments which is used to
 * maintain constant function prototype
